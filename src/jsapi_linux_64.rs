...
extern "C" {
    ...
    pub fn Evaluate(cx: *mut JSContext,
                    options: *const ReadOnlyCompileOptions,
                    srcBuf: *mut SourceBufferHolder, rval: MutableHandleValue) -> bool { false }
...
extern "C" {
    ...
    pub fn JS_GetObjectAsArrayBufferView(obj: *mut JSObject, length: *mut u32,
                                         data: *mut *mut u8) -> *mut JSObject { ::std::ptr::null_mut() }
...
extern "C" {
    ...
    pub fn JS_GetArrayBufferData(obj: *mut JSObject,
                                 arg1: *const AutoCheckCannotGC) -> *mut u8 { ::std::ptr::null_mut() }
...
extern "C" {
    ...
    pub fn JS_GetFloat32ArrayData(obj: *mut JSObject,
                                  arg1: *const AutoCheckCannotGC) -> *mut f32 { ::std::ptr::null_mut() }
